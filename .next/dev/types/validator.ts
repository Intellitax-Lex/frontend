...
// Validate ../../../app/api/qa-webhook/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/qa-webhook">> = Specific
  const handler = {} as typeof import("../../../app/api/qa-webhook/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
